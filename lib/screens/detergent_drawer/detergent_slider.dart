...
import 'package:flutter_whirlpool/screens/detergent_drawer/wave_container.dart';
...
class DetergentSlider extends StatefulWidget {
  DetergentSlider({
  ...
  @override
  DetergentSliderState createState() => DetergentSliderState();
}

class DetergentSliderState extends State<DetergentSlider>
...
class _DetergentSlide extends StatefulWidget {
  const _DetergentSlide({
  ...
  @override
  _DetergentSlideState createState() => _DetergentSlideState();
}

class _DetergentSlideState extends State<_DetergentSlide> {
